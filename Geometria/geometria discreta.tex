...
El lado contigo al ángulo diedral es justamente la apotema del triángulo que forma la base del tetraedro. Sabemos que la apotema de un triángulo equilátero es un tercio de la altura, en este caso será $1/3$. Como la hipotenusa (la altura de una cara) vale 1, podemos obtener el ángulo como el arco coseno de $1/3$.
