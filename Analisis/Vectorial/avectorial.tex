...
\begin{proof}[Demostración del Teorema de la Divergencia] ~
	...
	&=\int_{B_1}F ds+\int_{A_1}F ds-\int_D\int_0^1 F_1(\bar{x},sh(\bar{x}))h_{x_1}(\bar{x})dsd\bar{x}.
	\end{align*}
	Sustituyendo en \eqref{eq:div-1} obtenemos
	\begin{align*}
	\int_\Omega\frac{\partial F_1}{\partial x_1}(x)dx
	&=\int_{A_1\cup B_1}F ds\\&-\int_D\int_0^1 F_1(\bar{x},sh(\bar{x}))h_{x_1}(\bar{x})dsd\bar{x}+\dfrac{\partial F_1}{\partial x_N}(\bar{x},sh(\bar{x}))sh(\bar{x})h_{x_1}(\bar{x}) \ dsd\bar{x}.
	\end{align*}
	...
	\begin{align*}
	\int_\Omega\frac{\partial F_1}{\partial x_1}(x)dx
	&=\int_{A_1\cup B_1}F ds-\int_D F_1(\bar{x},h(\bar{x}))h_{x_1}(\bar{x})d\bar{x}.
	\end{align*}
	
	TODO: ahora agrupar todos
